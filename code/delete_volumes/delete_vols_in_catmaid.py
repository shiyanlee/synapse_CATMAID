...
API_TOKEN = "x"  # if sudo users token is provided, it will allow deleting others' data
HTTP_USER = "x"
HTTP_PASS = "x"
PROJECT_ID = 32
...
# verify prior to deleting - wont let you delete volumes by other users. Use requests with sudo user information below
